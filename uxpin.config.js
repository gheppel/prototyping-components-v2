module.exports = {
  components: {
    categories: [
      {
        name: "Theme Switcher",
        include: ["src/components/ThemeSwitcherGlobal/ThemeSwitcherGlobal.js"],
      },
      {
        name: "Buttons",
        include: [
      ...
      {
        name: "Rating",
        include: ["src/components/Rating/Rating.js"],
      },
      {
        name: "Select",
        include: ["src/components/Select/Select.js"],
      },
      {
        name: "Switches",
        include: [
      ...
      {
        name: "Text Field",
        include: ["src/components/TextField/TextField.js"],
      },
      {
        name: "Card",
        include: [
      ...
      {
        name: "Paper",
        include: ["src/components/Paper/Paper.js"],
      },
      {
        name: "List",
        include: [
  ...
  name: "MUI_Prototyping_Components",
};
